...
func assertResponse(t *testing.T, res *fasthttp.Response, responseCode int) {
	if responseCode != res.StatusCode() {
		t.Errorf("assertResponse: expected response code to be %d but got %d. ", responseCode, res.StatusCode())
	}
}
